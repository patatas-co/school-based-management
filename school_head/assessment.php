...
<div class="card">
  <div class="card-head">
    <span class="card-title">
      ...
      <span
        style="font-weight:400;color:var(--n-400);font-family:var(--font-body);font-size:13px;">(<?= count($cycles) ?>)</span>
    </span>
    <div class="search">
      ...
      <tbody>
        <?php foreach ($cycles as $c): ?>
          <tr>
            ...
            <td><span class="pill pill-<?= e($c['status']) ?>"><?= ucfirst(str_replace('_', ' ', $c['status'])) ?></span>
            </td>
            <td>
              <?php if ($c['overall_score']):
                ...
                <div class="score-bar-cell">
                  <div class="score-bar-track">
                    <div class="score-bar-fill" style="width:<?= $c['overall_score'] ?>%;background:<?= $mat['color'] ?>;">
                    </div>
                  </div>
                  <span class="score-val"
                    style="font-size:14px;color:<?= $mat['color'] ?>;"><?= $c['overall_score'] ?>%</span>
                </div>
...
<div class="overlay" id="mValidate">
  <div class="modal" style="max-width:540px;">
    ...
    <div class="modal-body">
      ...
      <div class="fg">
        <label>Remarks <span style="font-weight:400;color:var(--n-400);">(optional for validate, required for
            return)</span></label>
