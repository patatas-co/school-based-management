...
<div class="grid2" style="gap:20px;align-items:start;">
  ...
  <div class="settings-section">
    <div class="settings-section-header">
      ...
      <button class="btn btn-primary btn-sm" onclick="openModal('mSY');resetSY()" style="margin-left:auto;"><?= svgIcon('plus') ?> Add</button>
    </div>
  ...
  <div style="display:flex;flex-direction:column;gap:16px;">
    ...
    <div class="settings-section">
      ...
      <div class="info-row"><span class="info-label">Indicator Responses</span><span class="info-value"><?= number_format($responseCount) ?></span></div>
      <div class="info-row"><span class="info-label">PHP Version</span><span class="info-value" style="font-family:monospace;font-size:13px;"><?= phpversion() ?></span></div>
      <div class="info-row"><span class="info-label">DepEd Order Reference</span><span class="info-value" style="font-size:13px;">No. 007, s. 2024</span></div>
    </div>
