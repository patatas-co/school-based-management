-- ============================================================
-- SBM Monitoring System — Complete Database Schema
...
VALUES ('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@sbm.edu.ph', 'System Administrator', 'admin', 'active')
...
INSERT INTO sbm_dimensions (dimension_no, dimension_name, color_hex, icon, indicator_count, sort_order) VALUES
...
INSERT INTO sbm_indicators (dimension_id, indicator_code, indicator_text, mov_guide, sort_order) VALUES
-- Dimension 1
...
-- ── SAMPLE REGION / DIVISION / SCHOOL DATA ──────────────────
INSERT INTO regions (region_name, region_code) VALUES
('Region IV-A (CALABARZON)', 'REGION-IVA')
ON DUPLICATE KEY UPDATE region_name=region_name;

INSERT INTO divisions (region_id, division_name, division_code) VALUES
(1, 'Schools Division of Cavite', 'SDO-CAVITE')
ON DUPLICATE KEY UPDATE division_name=division_name;

INSERT INTO schools (division_id, school_name, school_id_deped, address, classification, school_head_name, total_enrollment, total_teachers) VALUES
(1, 'Dasmariñas Integrated High School', '301143', 'Dasmariñas City, Cavite', 'JHS', 'Maria Santos', 2500, 85)
