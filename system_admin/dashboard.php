...
<div class="sa-hero">
  ...
  <div style="position:relative; z-index:1;">
    <div style="font-family:var(--font-display);font-size:14px;font-weight:600;color:rgba(74,222,128,.9);margin-bottom:4px;">Welcome to</div>
    <div style="font-family:var(--font-display);font-size:30px;font-weight:800;line-height:1.1;">School-based Management System</div>
